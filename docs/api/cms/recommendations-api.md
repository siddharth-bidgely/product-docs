...
**Description:** Returns the recommendation model for a pilot, including the default profile, transformed recommendation records, and the last-updated timestamp for the requested external content status.
