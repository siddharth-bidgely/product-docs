...
**Description:** Returns the recommendation model for a pilot, including the default profile, transformed recommendation records, the last-updated timestamp for the requested external content status, and the requested region value.
...
* `region` echoes the `region` query parameter value when provided.
...
**Description:** Returns the number of recommendations available for a pilot after filtering by the requested external content status.
...
| Name     | Type   | Required | Description                                                             |
| -------- | ------ | -------: | ----------------------------------------------------------------------- |
| `status` | string |      Yes | External content status used to filter recommendations before counting. |
