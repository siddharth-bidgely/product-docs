...
* Associate survey templates with a **Region** to target specific geographic areas
...
* Manage question and template status (DRAFT, READY\_FOR\_REVIEW, READY\_TO\_PUBLISH, PUBLISHED)
...
4. Specify the **Region** that the template applies to (optional).
5. Override any question or choice text that should differ for this pilot.
6. Click **Save**; the template becomes available for all future pilots.
